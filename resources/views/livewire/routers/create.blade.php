...
new class extends Component {
    ...
    public function save()
    {
        ...
        session()->flash('success', 'Router added successfully.');
                    ...
                    <form wire:submit="save">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" wire:model="name" id="name" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="e.g., Main Router">
                                @error('name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                            </div>

                            <div>
                                <label for="ip_address" class="block text-sm font-medium text-gray-700">IP Address</label>
                                <input type="text" wire:model="ip_address" id="ip_address" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="e.g., 192.168.1.1">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="location" id="location" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="e.g., Main Office">
                            ...
                            <div>
                                <label for="api_username" class="block text-sm font-medium text-gray-700">API Username (Optional)</label>
                            ...
                            <div>
                                <label for="api_password" class="block text-sm font-medium text-gray-700">API Password (Optional)</label>
