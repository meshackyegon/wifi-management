          ...
          <div class="col-md-4">
            <div class="card feature-card">
              <div class="card-body text-center p-4">
                ...
                <div class="fs-4 fw-bold text-primary mb-3">Starting from $1</div>
          ...
          <div class="col-md-4">
            <div class="card feature-card border-primary">
              ...
              <div class="card-body text-center p-4">
                ...
                <div class="fs-4 fw-bold text-primary mb-3">Starting from $3</div>
                <ul class="list-unstyled">
          ...
          <div class="col-md-4">
            <div class="card feature-card">
              <div class="card-body text-center p-4">
                ...
                <div class="fs-4 fw-bold text-primary mb-3">Starting from $10</div>
                <ul class="list-unstyled">
